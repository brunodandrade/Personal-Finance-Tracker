...
})({"32kRF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ace7815d8199a21a";
"use strict";
...
},{}],"8sYvG":[function(require,module,exports,__globalThis) {
var _buttonsJs = require("./buttons.js");
var _transactionPross = require("./transactionPross");
var _display = require("./display");

},{"./buttons.js":"8wS56","./transactionPross":"3ZM2K","./display":"77JYK"}],"8wS56":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "closeWindowFunc", ()=>closeWindowFunc);
parcelHelpers.export(exports, "openWindowFunc", ()=>openWindowFunc);
...
},{}],"3ZM2K":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TransactionCreate {
    constructor(type, description, amount, category, timestamp = getCurrentTime(), date = getCurrentDate()){
        this.type = type;
...
function recentTransactionsUpdate() {
    ...
    if (!transactionsBottom.value || transactionsBottom.value === "transactions") allTransactions = [
        ...(0, _transactionProssJs.transactions)
    ];
...
function updateDisplay() {
    ...
    const savings = typeof allValues.savingsRate === "number" && !isNaN(allValues.savingsRate) ? allValues.savingsRate : 0;
...
},{"./math.js":"8A4F6","./transactionPross.js":"3ZM2K","chart.js/auto":"a3bOj","url:../icons/trash.png":"gxJJC","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8A4F6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "transactionsMath", ()=>transactionsMath);
var _transactionPross = require("./transactionPross");
function transactionsMath() {
    let total = [];
    let totalIncome = [];
    let totalExpenses = [];
    for(let i = 0; i < (0, _transactionPross.transactions).length; i++)if ((0, _transactionPross.transactions)[i].type === "expense") {
        total.push(Number((0, _transactionPross.transactions)[i].amount) * -1);
        totalExpenses.push(Number((0, _transactionPross.transactions)[i].amount));
    } else {
        total.push(Number((0, _transactionPross.transactions)[i].amount));
        totalIncome.push(Number((0, _transactionPross.transactions)[i].amount));
    }
    const expenseAverage = totalExpenses.length > 0 ? totalExpenses.reduce((a, b)=>a + b) / totalExpenses.length : 0;
    const largestExpense = totalExpenses.length > 0 ? Math.max(...totalExpenses) : 0;
    ...
    return {
        ...
        totalIncomeSum,
        totalExpenseSum,
        totalTransactions: (0, _transactionPross.transactions).length,
        savingsRate
    };
}

},{"./transactionPross":"3ZM2K","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gxJJC":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("trash.707231b7.png") + "?" + Date.now();

},{}]},["32kRF","8sYvG"], "8sYvG", "parcelRequire9030", {}, "./", "/")

//# sourceMappingURL=Personal-Finance-Tracker.8199a21a.js.map
